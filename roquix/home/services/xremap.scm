...
;; FIXME: xremap needs the environment variable XAUTHORITY, but it can be accessed only from login shell,
;;   while shepherd does not run login shell.
...
;;               (append
;;                '("DISPLAY=:0"
;;                  "XAUTHORITY=/home/${HOME}/.Xauthority")
